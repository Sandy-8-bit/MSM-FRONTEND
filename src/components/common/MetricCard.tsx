...
const MetricCard: React.FC<MetricCardProps> = ({
  ...
  return (
    <div className="metric-card flex w-full flex-row items-center justify-between rounded-xl border-[1.5px] border-slate-300 bg-white p-4">
      <div className="stats-contaienr flex flex-col">
        ...
        <div className="stats flex flex-row items-end gap-2">
          <h3 className="text-3xl font-semibold text-slate-800">{metric}</h3>
          <h4
